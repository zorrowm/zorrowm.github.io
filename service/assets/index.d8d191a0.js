import{r as pe}from"./ant-design-vue-exp.fcd30b7a.js";import{d as de,l as K,M as ye,N as ce,Q as N,q as H,a7 as te,ab as se,f as me,V as ne}from"./@vue-exp.a4e706db.js";import{M as Q,h as $e,j as ge}from"./xframelib-exp.f18cc8b7.js";import{_ as be}from"./index.aafe4c8d.js";import"./vendor.d3cc975b.js";import"./lodash-es-exp.01017e5f.js";import"./axios-exp.e066e043.js";import"./@hprose-exp.37e63ca6.js";const he=de({name:"",props:{},components:{},setup(M,{attrs:v,slots:ie,emit:re}){const J=K(),_=K(),V=K("Global.Config.ServiceURL.DefaultWebAPI"),w=new Map;let k=!0;async function oe(){if(!V.value){Q.Message?.warn("API\u8DEF\u5F84\u914D\u7F6E\u4E0D\u80FD\u4E3A\u7A7A");return}let r;if(J.value)r=JSON.parse(J.value);else{if(!_.value){Q.Message?.warn("\u7A7A\u8FDE\u63A5\uFF0C\u65E0\u6CD5\u5F00\u59CB\u4E0B\u8F7D");return}const y=await $e("",_.value);if(!y){Q.Message?.warn("\u65E0\u6CD5\u83B7\u53D6Swagger Json\u6570\u636E\uFF01");return}r=y.data}if(!r){Q.Message?.warn("Swagger Json\u4E3A\u7A7A\u5BF9\u8C61\uFF0C\u65E0\u6CD5\u8F93\u51FA\uFF01");return}w.clear();const e=r.info.title??"WebAPI";(!V.value||V.value.length===0)&&(V.value="Global.Config.ServiceURL.DefaultWebAPI"),k=ue();let l="";k&&(l=",ResponseType");let m=`	import{Global,requestGet,requestPost,requestPostBody${l}} from 'xframelib'
