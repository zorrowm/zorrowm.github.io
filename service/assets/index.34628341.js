import{r as ae}from"./ant-design-vue-exp.fcd30b7a.js";import{d as le,l as K,M as pe,N as ue,Q as k,q as N,a7 as Y,ab as Z,f as fe,V as G}from"./@vue-exp.a4e706db.js";import{M as _,h as de,j as ye}from"./xframelib-exp.f18cc8b7.js";import{_ as ce}from"./index.7033cca6.js";import"./vendor.d3cc975b.js";import"./lodash-es-exp.01017e5f.js";import"./axios-exp.e066e043.js";import"./@hprose-exp.37e63ca6.js";const me=le({name:"",props:{},components:{},setup(C,{attrs:j,slots:ee,emit:te}){const W=K(),J=K(),L=K("Global.Config.ServiceURL.DefaultWebAPI"),R=new Map;let E=!0;async function se(){if(!L.value){_.Message?.warn("API\u8DEF\u5F84\u914D\u7F6E\u4E0D\u80FD\u4E3A\u7A7A");return}let y;if(W.value)y=JSON.parse(W.value);else{if(!J.value){_.Message?.warn("\u7A7A\u8FDE\u63A5\uFF0C\u65E0\u6CD5\u5F00\u59CB\u4E0B\u8F7D");return}const f=await de("",J.value);if(!f){_.Message?.warn("\u65E0\u6CD5\u83B7\u53D6Swagger Json\u6570\u636E\uFF01");return}y=f.data}if(!y){_.Message?.warn("Swagger Json\u4E3A\u7A7A\u5BF9\u8C61\uFF0C\u65E0\u6CD5\u8F93\u51FA\uFF01");return}R.clear();const t=y.info.title??"WebAPI";(!L.value||L.value.length===0)&&(L.value="Global.Config.ServiceURL.DefaultWebAPI"),E=ie();let c="";E&&(c=",ResponseType");let m=`	import{Global,requestGet,requestPost,requestPostBody${c}} from 'xframelib'
