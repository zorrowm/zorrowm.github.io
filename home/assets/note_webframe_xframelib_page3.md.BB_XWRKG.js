import{_ as a,a as n,o as i,a_ as p}from"./chunks/framework.3NP7rA9x.js";const c=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"note/webframe/xframelib/page3.md","filePath":"note/webframe/xframelib/page3.md","lastUpdated":1703237225000}'),l={name:"note/webframe/xframelib/page3.md"};function e(t,s,h,k,r,g){return i(),n("div",null,s[0]||(s[0]=[p(`<h2 id="xframelib结构" tabindex="-1">xframelib结构 <a class="header-anchor" href="#xframelib结构" aria-label="Permalink to &quot;xframelib结构&quot;">​</a></h2><ul><li>Global 全局对象 Global对应模型为InnerObject，全局主要对象挂节点。</li></ul><div class="language-typescript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">export</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> interface</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> InnerObject</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  /**</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">   * axios对象</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">   */</span></span>
<span class="line"><span style="--shiki-light:#E36209;--shiki-dark:#FFAB70;">  Axios</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">:</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> AxiosStatic</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">; </span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">//AxiosStatic;</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"> //必须是any，因为涉及调用方法</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div><br><ol><li>Axios为默认的Axios对象</li><li>Config为网站的初始配置，对应配置文件为sysConfig.js</li><li>EventBus 为公共消息总线</li><li>DefaultProxyClient 为默认主要的HproseProxyClient调用hprose服务</li><li>Message 为弹框消息对象</li><li>Logger 为Console.log的控制台日志输出对象（可控制输出日志级别）</li></ol><ul><li><p>Global.Config为系统配置对象</p><p>对应模型对象ISystemConfig</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>export interface ISystemConfig {</span></span>
