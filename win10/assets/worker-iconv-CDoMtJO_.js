...
for (var I, x, k, C, M, U, j, N, P, D, F = a((e) => {
	...
	for (var t = {}, r = {
		...
		toByteArray: function(e) {
			for (var t, r = c(e), n = r[0], s = r[1], a = new o(function(e, t, r) {
				return 3 * (t + r) / 4 - r;
			}(0, n, s)), f = 0, u = s > 0 ? n - 4 : n, h = 0; h < u; h += 4) t = i[e.charCodeAt(h)] << 18 | i[e.charCodeAt(h + 1)] << 12 | i[e.charCodeAt(h + 2)] << 6 | i[e.charCodeAt(h + 3)], a[f++] = t >> 16 & 255, a[f++] = t >> 8 & 255, a[f++] = 255 & t;
			return 2 === s && (t = i[e.charCodeAt(h)] << 2 | i[e.charCodeAt(h + 1)] >> 4, a[f++] = 255 & t), 1 === s && (t = i[e.charCodeAt(h)] << 10 | i[e.charCodeAt(h + 1)] << 4 | i[e.charCodeAt(h + 2)] >> 2, a[f++] = t >> 8 & 255, a[f++] = 255 & t), a;
		},
	...
	var h = {
		...
		write: function(e, t, r, n, i, o) {
			...
			for (t = Math.abs(t), isNaN(t) || t === 1 / 0 ? (a = isNaN(t) ? 1 : 0, s = u) : (s = Math.floor(Math.log(t) / Math.LN2), t * (c = Math.pow(2, -s)) < 1 && (s--, c *= 2), (t += s + h >= 1 ? l / c : l * Math.pow(2, 1 - h)) * c >= 2 && (s++, c /= 2), s + h >= u ? (a = 0, s = u) : s + h >= 1 ? (a = (t * c - 1) * Math.pow(2, i), s += h) : (a = t * Math.pow(2, h - 1) * Math.pow(2, i), s = 0)); i >= 8; e[r + d] = 255 & a, d += p, a /= 256, i -= 8);
	...
	*/ (function(e) {
		...
		function K(e, t, r, n) {
			let i = 0;
			for (; i < n && !(i + r >= t.length || i >= e.length); ++i) t[i + r] = e[i];
			return i;
		}
		function Z(e, t) {
	...
	t.exports = function() {
		...
		return r && o(t.prototype, r), Object.defineProperty(t, "prototype", { writable: !1 }), e;
	}();
}), Be = a((e, t) => {
	function r(e, t) {
		i(e, t), n(e);
	...
	function B(e, t, r, i, o) {
		...
		if (null === t) f.reading = !1, function(e, t) {
			...
			var r, n = t;
			return s.isBuffer(n) || n instanceof a || "string" == typeof t || void 0 === t || e.objectMode || (r = new g("chunk", [
				"string",
				"Buffer",
				"Uint8Array"
			], t)), r;
...
}), Pe = ((r, n, s) => (s = null != r ? e(i(r)) : {}, f(!n && r && r.__esModule && o.call(r, "default") ? s : t(s, "default", {
	value: r,
	enumerable: !0
}), r)))(a((e, t) => {
	...
	toByteArray: function(e) {
		for (var t, r = Ge(e), n = r[0], i = r[1], o = new We(function(e, t, r) {
			return 3 * (t + r) / 4 - r;
		}(0, n, i)), s = 0, a = i > 0 ? n - 4 : n, c = 0; c < a; c += 4) t = qe[e.charCodeAt(c)] << 18 | qe[e.charCodeAt(c + 1)] << 12 | qe[e.charCodeAt(c + 2)] << 6 | qe[e.charCodeAt(c + 3)], o[s++] = t >> 16 & 255, o[s++] = t >> 8 & 255, o[s++] = 255 & t;
		return 2 === i && (t = qe[e.charCodeAt(c)] << 2 | qe[e.charCodeAt(c + 1)] >> 4, o[s++] = 255 & t), 1 === i && (t = qe[e.charCodeAt(c)] << 10 | qe[e.charCodeAt(c + 1)] << 4 | qe[e.charCodeAt(c + 2)] >> 2, o[s++] = t >> 8 & 255, o[s++] = 255 & t), o;
	},
	fromByteArray: function(e) {
