...
function O(e, r) {
	return "string" == typeof e && (e = k(e)), "string" == typeof r && (r = k(r)), null == e || 0 === e.length ? e : S(function(e, r) {
		for (var t, n, a, o = e.length, i = o - 1, s = e[i], c = 0, u = 0 | Math.floor(6 + 52 / o); u > 0; --u) {
			for (n = (c = U(c + E)) >>> 2 & 3, a = 0; a < i; ++a) t = e[a + 1], s = e[a] = U(e[a] + A(c, t, s, a, n, r));
			t = e[0], s = e[i] = U(e[i] + A(c, t, s, i, n, r));
		}
		return e;
	}(C(e, !0), C(T(r), !1)), !1);
}
...
function R(e, r) {
	return "string" == typeof e && (e = function(e) {
		...
		for (var t, n, a, o = e.length, i = o - 1, s = e[0], c = U(Math.floor(6 + 52 / o) * E); 0 !== c; c = U(c - E)) {
			for (n = c >>> 2 & 3, a = i; a > 0; --a) t = e[a - 1], s = e[a] = U(e[a] - A(c, s, t, a, n, r));
			t = e[i], s = e[0] = U(e[0] - A(c, s, t, 0, n, r));
		}
		return e;
	}(C(e, !1), C(T(r), !1)), !0);
}
