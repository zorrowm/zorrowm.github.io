import{c3 as x,c4 as I,c5 as R,c6 as T,c7 as w,c8 as p,c9 as y}from"./vendor-CDV5M84i.js";import{d as P,v as W,M as E,L as F,R as A}from"./@vue-exp-YaP0LnBg.js";import{_ as C}from"./index-DPO_t7vI.js";import"./@hprose-exp-DifMA6AO.js";import"./xframelib-exp-CvTEfE5n.js";import"./axios-exp-BH40TtQM.js";import"./vue-router-exp-BeFgxScw.js";const b=P({__name:"FireworksWidget",setup(u,{expose:o}){o();function r(){const l=new x,e=document.querySelector("#c"),i=new I({canvas:e});i.setSize(e.innerWidth,e.innerHeight),i.setPixelRatio(window.devicePixelRatio);const a=new R(60,e.clientWidth/e.clientHeight,1,1e3);a.position.z=4;const S=`
          out vec2 st;
          void main() {
            st =uv;
