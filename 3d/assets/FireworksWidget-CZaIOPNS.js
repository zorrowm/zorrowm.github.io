import{c4 as x,c5 as I,c6 as R,c7 as T,c8 as w,c9 as p,ca as y}from"./vendor-6kqmRazU.js";import{d as P,v as W,M as E,L as F,R as A}from"./@vue-exp-BA8o4xMK.js";import{_ as C}from"./index-CTmLOYTS.js";import"./@hprose-exp-BDOQuVAD.js";import"./xframelib-exp-CPl8XRlL.js";import"./axios-exp-BH40TtQM.js";import"./vue-router-exp-BxGuMefC.js";const b=P({__name:"FireworksWidget",setup(u,{expose:o}){o();function r(){const l=new x,e=document.querySelector("#c"),i=new I({canvas:e});i.setSize(e.innerWidth,e.innerHeight),i.setPixelRatio(window.devicePixelRatio);const a=new R(60,e.clientWidth/e.clientHeight,1,1e3);a.position.z=4;const S=`
          out vec2 st;
          void main() {
            st =uv;
